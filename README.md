...
```bash
bash <(curl -s https://raw.githubusercontent.com/Bee-7/ZanborPanel/main/zanbor.sh)
```
...
```bash
bash <(curl -s https://raw.githubusercontent.com/Bee-7/ZanborPanel/main/update.sh)
```
